...
class ResourceCandelarLeaves(models.Model):
    ...
    date_from_without_hour = fields.Date(string="Start Date Without Hour", copy=False)
    date_to_without_hour = fields.Date(string="End Date Without Hour", copy=False)
    ...
    def create(self, vals_list):
        ...
        employees_dates = leaves._catch_employees_contract_dates_to_treat([])
        if employees_dates:
