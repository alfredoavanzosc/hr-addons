...
class HrAttendance(models.Model):
    ...
    check_in_without_hour = fields.Date(copy=False)
    check_out_without_hour = fields.Date(copy=False)
    ...
    def _catch_employees_check_in_out_dates(self, employees_dates):
        for attendance in self.filtered(
            lambda x: x.check_in_without_hour and x.check_out_without_hour
        ):
            employees_dates = _catch_employees_dates_to_treat(
                employees_dates,
                attendance.employee_id,
                attendance.check_in_without_hour,
                attendance.check_out_without_hour,
